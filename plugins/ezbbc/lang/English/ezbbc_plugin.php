...
'Not writable'                  =>      'The <code>edit.php</code>, <code>post.php</code>, <code>viewtopic.php</code>, <code>header.php</code>, <code>include/parser.php</code>, and <code>plugins/ezbbc/config.php</code> files should be writable to perform installation or removing. Please change the permissions of these files to have this action work.', 
...
'Heading'		        =>	'Heading » [h]…[/h]',
'URL'		                =>	'Insert URL Link » [url=…]…[/url]',
'E-mail'		        =>	'Insert E-mail Link » [email=…]…[/email]',
'Image'			        =>	'Insert Image » [img=…]…[/img]',
